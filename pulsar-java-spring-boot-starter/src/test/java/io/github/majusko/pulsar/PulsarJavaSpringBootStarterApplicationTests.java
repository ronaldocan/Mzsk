...
class PulsarJavaSpringBootStarterApplicationTests {
    ...
    @Test
    void testProducerSendAsyncMethod() throws PulsarClientException, ExecutionException, InterruptedException {
        CompletableFuture<Void> future = producer.sendAsync("topic-async", new MyMsg("async")).thenAccept(messageId -> {
